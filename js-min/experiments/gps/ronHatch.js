import{BaseExperiment as n}from"../baseExperiment.js";class r extends n{static get id(){return"ron-hatch"}static get name(){return"Ron Hatch GPS Analysis"}static get category(){return"gps"}static get description(){return"GPS engineer analysis of timing corrections."}init(){this.satelliteAltitude=20200,this.satelliteVelocity=3.87,this.earthRotationVelocity=.465,this.orbitalVelocity=30,this.sagnacCorrectionApplied=!0,this.relativisticCorrectionApplied=!0,this.orbitalCorrectionApplied=!1,this.animationPhase=0}activate(){super.activate(),this.model.setState({ShowVault:!1,ShowFeGrid:!1,Description:"GPS: Corrections for rotation but NOT orbital motion."})}update(t){this.active&&(this.animationPhase+=t)}buildControls(t){const a=document.createElement("h3");a.textContent="Ron Hatch GPS Analysis",t.appendChild(a);const e=document.createElement("div");e.className="experiment-credentials",e.innerHTML=`
    ...
    `,t.appendChild(e);const i=document.createElement("div");i.className="experiment-table",i.innerHTML=`
    ...
    `,t.appendChild(i);const o=document.createElement("div");o.className="experiment-question",o.innerHTML=`
      ...
      <p>The orbital velocity is <strong>65\xD7 larger</strong> than the
      rotational velocity. If it existed, it would dominate the corrections.</p>
    `,t.appendChild(o),this.createComparisonPanel(t,`<strong>Mainstream claim:</strong> Orbital motion doesn't need
       ...
       IS needed for rotation. Both are "common mode" in the same sense.`,`<strong>Geocentric explanation:</strong> Earth is stationary.
       Rotation is real and needs correction. Orbital motion doesn't
       exist, so no correction is needed.<br><br>
       GPS works perfectly because it's designed for a stationary Earth.`)}getInfoPanel(){return`
      ...
      <p style="font-family:monospace; color:#f4a640;">\u0394t = 2A\u03C9/c\xB2 = 2vl/c\xB2</p>
      ...
      the aether wind changes, producing the 15\xB0/h readings on RLG and FOG systems.</p>
      ...
      <p style="margin-top:12px; font-size:11px; color:#888;">
        <a href="https://publish.obsidian.md/spaceaudits/99_Old/Notes/GPS+and+the+Mythology+of+Relativistic+Corrections" target="_blank" style="color:#f4a640;">
          \u{1F4DA} GPS Research Notes \u2192
        </a>
      </p>
    `}}var c=r;export{r as RonHatchExperiment,c as default};

//# sourceMappingURL=ronHatch.js.map
